...
//This file is for the content of the movie category page
...
const Content = () => {
  ...
  useEffect(() => {
    const promise = axios.get("http://localhost:8080/api/v1/db/data/v1/inft3050/Stocktake?where=(SourceId,btw,4,6)", {headers: headers})
